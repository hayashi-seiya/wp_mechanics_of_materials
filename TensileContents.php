...
<p>材料は引張力が強く作用すると破断してしまうが、その時点での引張応力のことを引っ張り強さと言い、単位は
    <?php getInlineTex("N/mm^2") ?>で表される。破断の仕方には2通りがあり、伸びてから破断するものと、伸びずに破断するものがある。伸びてから破断する材料には主に炭素鋼が挙げられ、伸びずに破断するものにはアルミニウム合金や鋳鉄が挙げられる。</p>
<h3>棒の伸び</h3>
<p>断面積に比べて長さが長い部材のことを棒と呼び、真っ直ぐな部材を真直棒と呼ぶ。</p>
<p><strong>P33 図3.2挿入</strong></p>
<p>図のように長さ<?php getInlineTex("l") ?>、断面積<?php getInlineTex("A") ?>の均質で等方な棒ABがある。
